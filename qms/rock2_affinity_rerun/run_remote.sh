...
cd /home/shadeform/rock2_affinity_rerun
LOG=/home/shadeform/rock2_affinity_rerun/run.log
echo "=== ROCK2 affinity rerun start $(date -u +%FT%TZ) ===" > "$LOG"
echo "GPU:" >> "$LOG"
nvidia-smi -L >> "$LOG"

/home/shadeform/miniconda3/envs/pxm_cu128/bin/boltz predict \
  /home/shadeform/rock2_affinity_rerun/in \
  --out_dir /home/shadeform/rock2_affinity_rerun/out \
